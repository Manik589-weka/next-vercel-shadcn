...
export interface Footer8Props {
  /** Link columns (e.g. Company, Resources, Follow us). */
  columns?: FooterColumn[];
  /** Bottom legal links. */
  legalLinks?: LegalLink[];
  /** Newsletter section heading. Hidden if undefined and showNewsletter is false. */
  newsletterHeading?: string;
  /** Whether to show the newsletter block. Default true. */
  showNewsletter?: boolean;
  /** Copyright text. Defaults to "Copyright © {year} ...". */
...
export function Footer8({
  ...
  const copyright =
    copyrightText ?? `Copyright © ${year} shadcndesign.com. All rights reserved.`;

  return (
    <footer
      className={cn(
        "section-padding-y border-border border-t",
        className
      )}
      role="contentinfo"
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          <div className="flex flex-col items-center justify-center gap-6 text-center lg:col-span-2 lg:items-start lg:justify-start lg:text-left">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="heading-sm">{newsletterHeading}</h2>
